...
namespace Lab_OOP1
{
    class WorkWithFile
    {
        public void WriteInFile(List<IFigure> list,string filename)
        {
            ...
            //string json= JsonSerializer.Serialize(hr, new JsonSerializerOptions { WriteIndented = true });
            File.WriteAllText(filename, json);

                //Console.WriteLine("Список сохранен в people.json");
        }
